...
export default function Cream() {
  ...
  return (
    <div className="size-full flex-1 flex flex-col justify-center items-center">
      <h1 className="font-bold pt-[30px] pl-[30px] bg-amber-400 text-white text-[50px] w-full text-left">
        Mango in stock
      </h1>
      ...
      <div className="relative flex h-full w-full items-center justify-center flex-1">
        ...
        <div
          ...
          className="border border-black rounded-[30px] p-5 w-[350px] h-[400px]
        ...
        <div
          className={`
            ...
            w-[250px] h-[350px] bg-lime-600 rounded-r-[30px]
